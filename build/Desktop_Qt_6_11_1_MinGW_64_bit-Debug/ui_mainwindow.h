...
public:
    ...
    QWidget *Autopartes;
    QLineEdit *txtPrecio_autoparte;
    QLabel *label_Stock_autoparte;
    QPushButton *btnGuardar_Autopartes;
    QLabel *label_ListaAutopartes;
    QTableWidget *tableWidget_Autopartes;
    QLabel *label_Nombre_autoparte;
    QPushButton *btnEliminar_Autopartes;
    QLabel *label_Marca_autoparte;
    QLabel *label_Autopartes;
    QLineEdit *txtBuscadorAutopartes;
    QPushButton *btnActualizar_Autopartes;
    QLineEdit *txtNombre_autoparte;
    QLineEdit *txtStock_autoparte;
    QLabel *label_Precio_autoparte;
    QLineEdit *txtMarca_autoparte;
    QWidget *tab;
    QLineEdit *txtTelefono_proveedor;
    QLabel *label_Nombre_proveedor;
    QLabel *label_Autopartes_2;
    QLineEdit *txtBuscadorProveedor;
    QLineEdit *txtPrecio_autoparte_2;
    QLabel *label_Direccion_proveedor;
    QTableWidget *tableWidget_Proveedor;
    QLineEdit *txtDireccion_proveedor;
    QLabel *label_ListaAutopartes_2;
    QPushButton *btnEliminar_proveedor;
    QLabel *label_Telefono_proveedor;
    QPushButton *btnActualizar_proveedor;
    QLineEdit *txtNombre_autoparte_2;
    QLabel *label_Email_proveedor;
    QPushButton *btnGuardar_proveedor;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tableWidget_Mantenimientos->setGeometry(QRect(290, 100, 421, 401));
        tabWidget->addTab(Mantenimientos, QString());
        Autopartes = new QWidget();
        Autopartes->setObjectName("Autopartes");
        txtPrecio_autoparte = new QLineEdit(Autopartes);
        txtPrecio_autoparte->setObjectName("txtPrecio_autoparte");
        txtPrecio_autoparte->setGeometry(QRect(20, 140, 113, 24));
        label_Stock_autoparte = new QLabel(Autopartes);
        label_Stock_autoparte->setObjectName("label_Stock_autoparte");
        label_Stock_autoparte->setGeometry(QRect(150, 100, 101, 40));
        btnGuardar_Autopartes = new QPushButton(Autopartes);
        btnGuardar_Autopartes->setObjectName("btnGuardar_Autopartes");
        btnGuardar_Autopartes->setGeometry(QRect(30, 190, 80, 24));
        label_ListaAutopartes = new QLabel(Autopartes);
        label_ListaAutopartes->setObjectName("label_ListaAutopartes");
        label_ListaAutopartes->setGeometry(QRect(440, 0, 161, 41));
        label_ListaAutopartes->setFont(font);
        tableWidget_Autopartes = new QTableWidget(Autopartes);
        tableWidget_Autopartes->setObjectName("tableWidget_Autopartes");
        tableWidget_Autopartes->setGeometry(QRect(290, 100, 421, 401));
        label_Nombre_autoparte = new QLabel(Autopartes);
        label_Nombre_autoparte->setObjectName("label_Nombre_autoparte");
        label_Nombre_autoparte->setGeometry(QRect(20, 20, 121, 40));
        btnEliminar_Autopartes = new QPushButton(Autopartes);
        btnEliminar_Autopartes->setObjectName("btnEliminar_Autopartes");
        btnEliminar_Autopartes->setGeometry(QRect(170, 190, 80, 24));
        label_Marca_autoparte = new QLabel(Autopartes);
        label_Marca_autoparte->setObjectName("label_Marca_autoparte");
        label_Marca_autoparte->setGeometry(QRect(160, 20, 91, 40));
        label_Autopartes = new QLabel(Autopartes);
        label_Autopartes->setObjectName("label_Autopartes");
        label_Autopartes->setGeometry(QRect(290, 20, 75, 40));
        txtBuscadorAutopartes = new QLineEdit(Autopartes);
        txtBuscadorAutopartes->setObjectName("txtBuscadorAutopartes");
        txtBuscadorAutopartes->setGeometry(QRect(290, 60, 421, 24));
        btnActualizar_Autopartes = new QPushButton(Autopartes);
        btnActualizar_Autopartes->setObjectName("btnActualizar_Autopartes");
        btnActualizar_Autopartes->setGeometry(QRect(100, 230, 80, 24));
        txtNombre_autoparte = new QLineEdit(Autopartes);
        txtNombre_autoparte->setObjectName("txtNombre_autoparte");
        txtNombre_autoparte->setGeometry(QRect(20, 60, 113, 24));
        txtStock_autoparte = new QLineEdit(Autopartes);
        txtStock_autoparte->setObjectName("txtStock_autoparte");
        txtStock_autoparte->setGeometry(QRect(150, 140, 113, 24));
        label_Precio_autoparte = new QLabel(Autopartes);
        label_Precio_autoparte->setObjectName("label_Precio_autoparte");
        label_Precio_autoparte->setGeometry(QRect(20, 100, 101, 40));
        txtMarca_autoparte = new QLineEdit(Autopartes);
        txtMarca_autoparte->setObjectName("txtMarca_autoparte");
        txtMarca_autoparte->setGeometry(QRect(160, 60, 113, 24));
        tabWidget->addTab(Autopartes, QString());
        tab = new QWidget();
        tab->setObjectName("tab");
        txtTelefono_proveedor = new QLineEdit(tab);
        txtTelefono_proveedor->setObjectName("txtTelefono_proveedor");
        txtTelefono_proveedor->setGeometry(QRect(160, 60, 113, 24));
        label_Nombre_proveedor = new QLabel(tab);
        label_Nombre_proveedor->setObjectName("label_Nombre_proveedor");
        label_Nombre_proveedor->setGeometry(QRect(20, 20, 121, 40));
        label_Autopartes_2 = new QLabel(tab);
        label_Autopartes_2->setObjectName("label_Autopartes_2");
        label_Autopartes_2->setGeometry(QRect(290, 20, 75, 40));
        txtBuscadorProveedor = new QLineEdit(tab);
        txtBuscadorProveedor->setObjectName("txtBuscadorProveedor");
        txtBuscadorProveedor->setGeometry(QRect(290, 60, 421, 24));
        txtPrecio_autoparte_2 = new QLineEdit(tab);
        txtPrecio_autoparte_2->setObjectName("txtPrecio_autoparte_2");
        txtPrecio_autoparte_2->setGeometry(QRect(20, 140, 113, 24));
        label_Direccion_proveedor = new QLabel(tab);
        label_Direccion_proveedor->setObjectName("label_Direccion_proveedor");
        label_Direccion_proveedor->setGeometry(QRect(150, 100, 101, 40));
        tableWidget_Proveedor = new QTableWidget(tab);
        tableWidget_Proveedor->setObjectName("tableWidget_Proveedor");
        tableWidget_Proveedor->setGeometry(QRect(290, 100, 421, 401));
        txtDireccion_proveedor = new QLineEdit(tab);
        txtDireccion_proveedor->setObjectName("txtDireccion_proveedor");
        txtDireccion_proveedor->setGeometry(QRect(150, 140, 113, 24));
        label_ListaAutopartes_2 = new QLabel(tab);
        label_ListaAutopartes_2->setObjectName("label_ListaAutopartes_2");
        label_ListaAutopartes_2->setGeometry(QRect(440, 0, 181, 41));
        label_ListaAutopartes_2->setFont(font);
        btnEliminar_proveedor = new QPushButton(tab);
        btnEliminar_proveedor->setObjectName("btnEliminar_proveedor");
        btnEliminar_proveedor->setGeometry(QRect(170, 190, 80, 24));
        label_Telefono_proveedor = new QLabel(tab);
        label_Telefono_proveedor->setObjectName("label_Telefono_proveedor");
        label_Telefono_proveedor->setGeometry(QRect(160, 20, 91, 40));
        btnActualizar_proveedor = new QPushButton(tab);
        btnActualizar_proveedor->setObjectName("btnActualizar_proveedor");
        btnActualizar_proveedor->setGeometry(QRect(100, 230, 80, 24));
        txtNombre_autoparte_2 = new QLineEdit(tab);
        txtNombre_autoparte_2->setObjectName("txtNombre_autoparte_2");
        txtNombre_autoparte_2->setGeometry(QRect(20, 60, 113, 24));
        label_Email_proveedor = new QLabel(tab);
        label_Email_proveedor->setObjectName("label_Email_proveedor");
        label_Email_proveedor->setGeometry(QRect(20, 100, 101, 40));
        btnGuardar_proveedor = new QPushButton(tab);
        btnGuardar_proveedor->setObjectName("btnGuardar_proveedor");
        btnGuardar_proveedor->setGeometry(QRect(30, 190, 80, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(Alquiler), QCoreApplication::translate("MainWindow", "Page", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(Incidentes), QCoreApplication::translate("MainWindow", "Page", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(Mantenimientos), QCoreApplication::translate("MainWindow", "Page", nullptr));
        label_Stock_autoparte->setText(QCoreApplication::translate("MainWindow", "Stock:", nullptr));
        btnGuardar_Autopartes->setText(QCoreApplication::translate("MainWindow", "Guardar", nullptr));
        label_ListaAutopartes->setText(QCoreApplication::translate("MainWindow", "Lista de Autopartes", nullptr));
        label_Nombre_autoparte->setText(QCoreApplication::translate("MainWindow", "Nombre de autoparte:", nullptr));
        btnEliminar_Autopartes->setText(QCoreApplication::translate("MainWindow", "Eliminar", nullptr));
        label_Marca_autoparte->setText(QCoreApplication::translate("MainWindow", "Marca:", nullptr));
        label_Autopartes->setText(QCoreApplication::translate("MainWindow", "Buscador:", nullptr));
        txtBuscadorAutopartes->setPlaceholderText(QCoreApplication::translate("MainWindow", "Buscar por nombre, marca, precio o cantidad de stock", nullptr));
        btnActualizar_Autopartes->setText(QCoreApplication::translate("MainWindow", "Actualizar", nullptr));
        label_Precio_autoparte->setText(QCoreApplication::translate("MainWindow", "Precio:", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(Autopartes), QCoreApplication::translate("MainWindow", "Page", nullptr));
        label_Nombre_proveedor->setText(QCoreApplication::translate("MainWindow", "Nombre proveedor:", nullptr));
        label_Autopartes_2->setText(QCoreApplication::translate("MainWindow", "Buscador:", nullptr));
        ...
        label_Direccion_proveedor->setText(QCoreApplication::translate("MainWindow", "Direccion:", nullptr));
        label_ListaAutopartes_2->setText(QCoreApplication::translate("MainWindow", "Lista de proveedores", nullptr));
        btnEliminar_proveedor->setText(QCoreApplication::translate("MainWindow", "Eliminar", nullptr));
        label_Telefono_proveedor->setText(QCoreApplication::translate("MainWindow", "Telefono:", nullptr));
        btnActualizar_proveedor->setText(QCoreApplication::translate("MainWindow", "Actualizar", nullptr));
        label_Email_proveedor->setText(QCoreApplication::translate("MainWindow", "Email:", nullptr));
        btnGuardar_proveedor->setText(QCoreApplication::translate("MainWindow", "Guardar", nullptr));
